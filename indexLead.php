...
>
    ...
    <section class="mt-36">
        <div class="container px-6 py-16 mx-auto text-center">
            ...
            <div class="max-w-lg mx-auto">
                <h1 class="text-6xl font-semibold text-orange-800 tracking-wider">Selamat Datang <b>Champions!</b></h1>
                ...
                <div class="flex justify-center space-x-4 mt-12">
                    <button onclick="navigateToPage('src/signup.html')" class="text-white h-10 px-4 py-2 transition-colors duration-300 transform bg-orange-500 rounded-md hover:bg-orange-400 focus:outline-none focus:bg-orange-400">
                        Gabung Kami!
                    </button>
                    <button onclick="navigateToPage('src/panduan.html')" class="text-white h-10 px-4 py-2 transition-colors duration-300 transform bg-orange-500 rounded-md hover:bg-orange-400 focus:outline-none focus:bg-orange-400">
                        Panduan
                    </button>
                </div>
            </div>
    ...
    <section id="about" class="mt-12">
        <div class="container px-6 py-10 mx-auto text-center">
            ...
            <div id="fitur" class="mt-36 animate-fadeIn opacity-0 ease-in-out transition-opacity duration-4500">
                ...
                <div class="grid grid-cols-1 gap-8 mt-8 xl:mt-12 xl:gap-12 md:grid-cols-2 xl:grid-cols-3">
                    <div class="p-8 space-y-3 border-2 border-orange-400 rounded-xl">
                        ...
                        <p class="text-gray-500">
                            Fitur <b>Pencatatan Prestas</b>i memungkinkan mahasiswa untuk mengunggah data prestasi mereka melalui formulir yang terstruktur dan mudah diakses. Data yang diunggah akan tersimpan dalam sistem secara otomatis, sehingga mempermudah pengelolaan dan pencatatan.
                        </p>
                    </div>
        ...
        <div class="container px-6 py-10 mx-auto -mt-72 sm:-mt-80 md:-mt-96 ">
            <div class="grid xl:grid-cols-5 md:grid-cols-2 gap-8 mt-8 xl:mt-16 animate-fadeIn opacity-0 ease-in-out transition-opacity duration-4500">
                ...
                <div class="flex flex-col items-center text-center p-4 border border-orange-400 sm:p-6 rounded-xl bg-white">
                    ...
                    <p class="mt-6 text-gray-500 capitalize ">Project Manager & Fullstack Developer</p>
    ...
    <section class="mt-20">
        <div class="container px-6 py-10 mx-auto text-center animate-fadeIn opacity-0 ease-in-out transition-opacity duration-4500">
            ...
            <div class="flex justify-center space-x-4 mt-4">
                <button onclick="navigateToPage('src/signup.html')" class="cursor-pointer inline-block text-white transition-all duration-300 tracking-normal h-10 px-4 py-2 transition-colors duration-300 transform bg-orange-500 rounded-md hover:bg-orange-400 hover:h-15 hover:tracking-widest focus:outline-none focus:bg-orange-400">
                    Gabung!
                </button>
            </div>
        </div>
